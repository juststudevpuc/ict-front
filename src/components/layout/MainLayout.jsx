...
export default function MainLayout() {
  ...
  const nav_item = [
    ...
    //   label: "Academics",
    //   children: [
    //     { to: "/coursePage", label: "School of Engineering" },
    //     { to: "/coursePage", label: "Research Projects" },
    //   ],
    // },
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 font-sans text-slate-900">
      ...
      {/* --- UTILITY BAR --- */}
      {/* Slightly darker than Oxford Blue for contrast */}
      <div className="bg-[#00152e] text-white text-[10px] uppercase tracking-widest font-bold py-2 px-6 hidden lg:flex justify-end gap-6 items-center">
        ...
        <span className="hover:text-amber-500 cursor-pointer transition-colors">Faculty & Staff</span>
        <span className="hover:text-amber-500 cursor-pointer transition-colors">Student Portal</span>
      ...
      <header className="sticky top-0 z-40 w-full bg-[#002147] shadow-md border-b border-[#00152e]">
        ...
        >
          ...
          <div className="flex lg:hidden gap-4">
             <button className="text-white hover:text-amber-400 transition-colors"><Search className="w-5 h-5"/></button>
            <button
              type="button"
              ...
              {nav_item.map((item) =>
                item.children ? (
                  ...
                  <Link
                    key={item.label}
                    to={item.to}
                    // Text changed to white, hover changed to amber
                  ...
                  >
                    {item.label}
                    {/* Underline Animation changed to amber */}
        ...
        {/* MOBILE MENU DIALOG */}
        {/* Kept white for readability, but updated accents to Oxford Blue */}
        <Dialog
          open={mobileMenuOpen}
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-100 pb-6">
              <div className="flex flex-col">
                  <span className="text-[#002147] font-serif font-bold text-lg">ICT Center</span>
                  <span className="text-[10px] uppercase text-slate-500 tracking-widest">Mobile Navigation</span>
              </div>
              <button
                type="button"
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-slate-100">
                ...
                <div className="py-6 space-y-3">
                     <Link to="#" className="block text-xs font-semibold text-slate-500 hover:text-[#002147] uppercase tracking-wider">Student Portal</Link>
                     <Link to="#" className="block text-xs font-semibold text-slate-500 hover:text-[#002147] uppercase tracking-wider">Faculty Access</Link>
                </div>
              </div>
            </div>
          </DialogPanel>
      ...
      <footer className="bg-[#00152e] text-slate-300 py-16 border-t-4 border-amber-500">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2">
                <h3 className="text-white font-serif text-2xl font-bold mb-4">ICT Center of Technology</h3>
                <p className="text-sm leading-relaxed max-w-md text-slate-400">
                    Dedicated to the advancement of knowledge and the education of students in science, technology, and other areas of scholarship that will best serve the nation and the world in the 21st century.
                </p>
                <div className="mt-6 flex gap-4">
                     <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-amber-500 transition-colors cursor-pointer text-white font-serif">f</div>
                     <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-amber-500 transition-colors cursor-pointer text-white font-serif">x</div>
                     <div className="w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center hover:bg-amber-500 transition-colors cursor-pointer text-white font-serif">in</div>
                </div>
            </div>
            ...
            <div>
                ...
                <ul className="space-y-3 text-sm">
                    <li><Link to="#" className="hover:text-amber-500 transition-colors">Apply for Admission</Link></li>
                    <li><Link to="#" className="hover:text-amber-500 transition-colors">Campus Map</Link></li>
                    <li><Link to="#" className="hover:text-amber-500 transition-colors">Academic Calendar</Link></li>
                    <li><Link to="#" className="hover:text-amber-500 transition-colors">Library</Link></li>
                </ul>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500 uppercase tracking-widest">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
                ...
                <Link to="#" className="hover:text-white">Emergency Info</Link>
            </div>
        </div>
      </footer>
    </div>
